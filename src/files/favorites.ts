 ...
 * server for `io.cozy.files`, so the change was applied optimistically and then
 * lost on the next sync (the folder reappeared in Favoris). We merge into the
 * existing cozyMetadata to preserve the server-managed fields.
 */
